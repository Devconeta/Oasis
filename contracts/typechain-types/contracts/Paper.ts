...
export interface PaperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
  ...
  encodeFunctionData(
    functionFragment: "baseFundingPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "referenceBalances",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "referenceRoyalty",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace FundedEvent {
  export type InputTuple = [
    from: AddressLike,
    amount: BigNumberish,
    mintedUnits: BigNumberish
  ];
  export type OutputTuple = [from: string, amount: bigint, mintedUnits: bigint];
  export interface OutputObject {
    from: string;
    amount: bigint;
    mintedUnits: bigint;
...
export namespace ReferencePaperEvent {
...
export interface Paper extends BaseContract {
  connect(runner?: ContractRunner | null): Paper;
  ...
  baseFundingPrice: TypedContractMethod<[], [bigint], "view">;
  ...
  publishPaper: TypedContractMethod<[_newuri: string], [void], "nonpayable">;

  referenceBalances: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  referenceRoyalty: TypedContractMethod<[], [bigint], "view">;

  references: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "baseFundingPrice"
  ...
  getFunction(
    nameOrSignature: "publishPaper"
  ): TypedContractMethod<[_newuri: string], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "referenceBalances"
  ): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "referenceRoyalty"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getEvent(
    ...
    ReferencePaperEvent.InputTuple,
    ReferencePaperEvent.OutputTuple,
    ReferencePaperEvent.OutputObject
  >;
  getEvent(
    key: "TransferBatch"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ReferencePaper(address,address)": TypedContractEvent<
      ReferencePaperEvent.InputTuple,
      ReferencePaperEvent.OutputTuple,
      ReferencePaperEvent.OutputObject
    >;
    ReferencePaper: TypedContractEvent<
      ReferencePaperEvent.InputTuple,
      ReferencePaperEvent.OutputTuple,
      ReferencePaperEvent.OutputObject
    >;
